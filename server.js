...
// **********************************************
// 🌟🌟🌟 التعديل الحاسم لخدمة الملفات الثابتة 🌟🌟🌟
// **********************************************

// هذا السطر يخبر Express بأن يعرض الملفات الثابتة 
// (مثل app.js و index.html) الموجودة في المجلد الحالي.
// ❌ كان: app.use(express.static(path.join(__dirname, '')));
// ✅ أصبح: استخدام المجلد الحالي مباشرة
app.use(express.static(__dirname)); 


// هذا السطر يوجه طلب المسار الأساسي (/) ليعرض ملف index.html
// ❌ كان: res.sendFile(path.join(__dirname, 'index.html'));
// ✅ أصبح: استخدام مسار الملف مباشرة في المجلد الحالي
app.get('/', (req, res) => {
